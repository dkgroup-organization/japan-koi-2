...
class dkg_import_product_var_wizard(models.TransientModel):
    _name = "dkg.import.product.var.wizard"
    _description = "Wizard Import Product Variant Wizard"

    def dkg_import_product_var_apply(self):  # Through wizard
        ...
        if variant_ids:
            ...
            for i in variant_ids:
                if not i.is_created:
                    continue
                product_tmpl_obj_all = self.env[
                    "dkg.import.product.variant.template"
                ].search([("name", "=", i.name)])
                varint_ids = []
                varint_value_ids = {}
                count = 0
                for rec in product_tmpl_obj_all:
                    if not rec.is_created:
                        continue
                    is_product = self.env["product.product"].search(
                    ...
                    if rec.category_path:
                        path = rec.category_path.split("/")
                        count = 0
                        for path_rec in path:
                            if count == 0:
                                catege_id = catge_obj.search(
                                    [("name", "=", path_rec.strip().capitalize())]
                                )
                                if not catege_id:
                                    catege_id = catge_obj.create(
                                        {
                                            "name": path_rec.strip().capitalize(),
                                            "parent_id": False,
                                        }
                                ...
                                cate_1 = catge_obj.search(
                                    [("name", "=", path_rec.strip().capitalize())]
                                )
                                if not cate_1:
                                    cate_1 = catge_obj.create(
                                        {
                                            "name": path_rec.strip().capitalize(),
                                            "parent_id": catege_id.id,
                                        }
                                    )
                                count += 1
                                catege_id = cate_1
                                category_ids[rec.id] = catege_id.id
                    if not rec.category_path and rec.category_level_0:
                        ...
                        if rec.category_level_1:
                            category_level_1 = catge_obj.search(
                                [
                                    (
                                        "name",
                                        "=",
                                        rec.category_level_1.strip().capitalize(),
                                    ),
                            ...
                            if rec.category_level_2:
                                category_level_2 = catge_obj.search(
                                    [
                                        (
                                            "name",
                                            "=",
                                            rec.category_level_2.strip().capitalize(),
                                        ),
                                ...
                                if rec.category_level_3:
                                    category_level_3 = catge_obj.search(
                                        [
                                            (
                                                "name",
                                                "=",
                                                rec.category_level_3.strip().capitalize(),
                                            ),
                                    ...
                                    if rec.category_level_4:
                                        category_level_4 = catge_obj.search(
                                            [
                                                (
                                                    "name",
                                                    "=",
                                                    rec.category_level_4.strip().capitalize(),
                                                ),
                                        ...
                                        if rec.category_level_5:
                                            category_level_5 = catge_obj.search(
                                                [
                                                    (
                                                        "name",
                                                        "=",
                                                        rec.category_level_5.strip().capitalize(),
                                                    ),
                                                    (
                                                        "parent_id",
                                                        "=",
                    ...
                    if rec.variant_1_attribute and rec.variant_1_attribute_value:
                        attribute_id = attribute_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_1_attribute.strip().capitalize(),
                                )
                            ]
                        )
                        if not attribute_id:
                        ...
                        attribute_value_id = attribute_value_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_1_attribute_value.strip().capitalize(),
                                ),
                        ...
                        if varint_value_ids.get(attribute_id.id):
                            if attribute_value_id.id not in varint_value_ids.get(
                                attribute_id.id
                            ):
                                varint_value_ids.get(attribute_id.id).append(
                        ...
                        attribute_id = attribute_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_2_attribute.strip().capitalize(),
                                )
                            ]
                        )
                        if not attribute_id:
                        ...
                        attribute_value_id = attribute_value_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_2_attribute_value.strip().capitalize(),
                                ),
                                ("attribute_id", "=", attribute_id.id),
                            ]
                        )
                        ...
                        attribute_id = attribute_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_3_attribute.strip().capitalize(),
                                )
                            ]
                        )
                        if not attribute_id:
                        ...
                        attribute_value_id = attribute_value_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_3_attribute_value.strip().capitalize(),
                                ),
                                ("attribute_id", "=", attribute_id.id),
                            ]
                        )
                        ...
                        attribute_id = attribute_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_4_attribute.strip().capitalize(),
                                )
                            ]
                        )
                        if not attribute_id:
                        ...
                        attribute_value_id = attribute_value_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_4_attribute_value.strip().capitalize(),
                                ),
                                ("attribute_id", "=", attribute_id.id),
                            ]
                        )
                        ...
                        attribute_id = attribute_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_5_attribute.strip().capitalize(),
                                )
                            ]
                        )
                        if not attribute_id:
                        ...
                        attribute_value_id = attribute_value_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_5_attribute_value.strip().capitalize(),
                                ),
                                ("attribute_id", "=", attribute_id.id),
                            ]
                        )
                        ...
                        attribute_id = attribute_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_6_attribute.strip().capitalize(),
                                )
                            ]
                        )
                        if not attribute_id:
                        ...
                        attribute_value_id = attribute_value_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_6_attribute_value.strip().capitalize(),
                                ),
                                ("attribute_id", "=", attribute_id.id),
                            ]
                        )
                        ...
                        attribute_id = attribute_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_7_attribute.strip().capitalize(),
                                )
                            ]
                        )
                        if not attribute_id:
                        ...
                        attribute_value_id = attribute_value_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_7_attribute_value.strip().capitalize(),
                                ),
                                ("attribute_id", "=", attribute_id.id),
                            ]
                        )
                        ...
                        attribute_id = attribute_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_8_attribute.strip().capitalize(),
                                )
                            ]
                        )
                        if not attribute_id:
                        ...
                        attribute_value_id = attribute_value_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_8_attribute_value.strip().capitalize(),
                                ),
                                ("attribute_id", "=", attribute_id.id),
                            ]
                        )
                        ...
                        attribute_id = attribute_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_9_attribute.strip().capitalize(),
                                )
                            ]
                        )
                        if not attribute_id:
                        ...
                        attribute_value_id = attribute_value_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_9_attribute_value.strip().capitalize(),
                                ),
                                ("attribute_id", "=", attribute_id.id),
                            ]
                        )
                        ...
                        attribute_id = attribute_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_10_attribute.strip().capitalize(),
                                )
                            ]
                        )
                        if not attribute_id:
                        ...
                        attribute_value_id = attribute_value_obj.search(
                            [
                                (
                                    "name",
                                    "=",
                                    rec.variant_10_attribute_value.strip().capitalize(),
                                ),
                                ("attribute_id", "=", attribute_id.id),
                            ]
                        )
                ...
                vals = {
                    ...
                    "categ_id": category_ids and category_ids[i.id] or 1,
                    "sale_delay": i.sale_delay,
                }
                atr_li = []
                ...
                vals.update({"attribute_line_ids": atr_li})
                if i.type:
                    ...
                    for rec in product_tmpl_obj_all:
                        ...
                        if rec.variant_1_attribute and rec.variant_1_attribute_value:
                            ...
                            product_varint_id = product_varint_obj.search(
                                [
                                    ("product_tmpl_id", "=", product_id.id),
                                    (
                ...
                product_ids.write({"active": False})
            if not is_import:
                raise Warning(
                    "No data Imported either data was already imported or something missing!"
                )
        else:
            raise Warning(
                "No data exist please fill the template, import it, then launch this wizard"
            )
        # self.env['dkg.import.product.variant.template'].search([])
        ...
        # Loop to add vendor pricelist

        # res = self.show_success_msg("Done, all products are imported !!")
        # return res
