        ...
        for order in self:
            ...
            if order.warehouse_id.cancel_invoice:
                ...
                for invoice in order.invoice_ids:
                    if invoice.journal_id and invoice.journal_id.restrict_mode_hash_table:
                    ...
                    if invoice.state in ['draft','open']:
                        ...
                        moves = invoice
                        if moves and moves.journal_id.restrict_mode_hash_table:
                            moves.write({'restrict_mode_hash_table': False})
                        invoice.button_cancel()
